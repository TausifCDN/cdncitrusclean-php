...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	  <form action="<?php echo admin_base_url();?>/products/update?id=<?php echo $productData->id;?>" method="POST" enctype="multipart/form-data">
		<div class="row">
		  <div class="col-sm-8">
			  <div class="x_panel">
				  <div class="x_title">
					  <h2 class="sub_title">Edit Product</h2>
				  ...
				  <div class="x_content">
					...
					<div class="col-sm-12 form-group has-feedback" style="position: relative;">
					  ...
					  <input type="text" name="product_name" class="form-control" required value="<?php echo $productData->product_name;?>">
					...
					<div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback" style="position: relative;">
					  ...
					  <input type="number" name="was_price" class="form-control" required value="<?php echo $productData->was_price;?>">
					  <span class="hws_error text-right text-danger"></span>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback" style="position: relative;">
					  <label for="name" class="hws_form_label">Sale Price:<span class="text-danger small">* </span></label>
					  <input type="number" name="sale_price" class="form-control" required value="<?php echo $productData->sale_price;?>">
					  <span class="hws_error text-right text-danger"></span>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback" style="position: relative;">
					  <label for="name" class="hws_form_label">Quantity Discount:<span class="text-danger small">* </span></label>
					  <input type="number" name="on_qty_discount" class="form-control" required value="<?php echo $productData->on_qty_discount;?>">
					  <span class="hws_error text-right text-danger"></span>
					</div>
					<div class="col-md-6 col-sm-12 col-xs-12 form-group has-feedback" style="position: relative;">
					  <label for="name" class="hws_form_label">Discount(%):<span class="text-danger small">* </span></label>
					  <input type="number" name="discount_percentage" class="form-control" required value="<?php echo $productData->discount_percentage;?>">
					  <span class="hws_error text-right text-danger"></span>
					</div>
					<div class="col-sm-12 form-group has-feedback" style="position: relative;">
					...
					<div class="col-sm-12 form-group has-feedback" style="position: relative;">
					  ...
					  <textarea name="description" id="editor" class="form-control"><?php echo $productData->description;?></textarea>
					  <span class="hws_error text-right text-danger"></span>
					</div>
					</div>
				  </div>
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="product_image">
                            ...
                            <img class="side_img" src="<?= base_url(); ?>/uploads/products/<?php echo $productData->product_image;?>">
                            <?php } ?>
                        </div>
                    </div>
                </div>
