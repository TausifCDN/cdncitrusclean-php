...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	  <form action="<?php echo base_url();?>/Findus/updatefindus?id=<?php echo $findusData->id;?>" method="POST" enctype="multipart/form-data">
		<div class="row">
		  <div class="col-sm-8">
			  <div class="x_panel">
				  <div class="x_title">
				  ...
				  <div class="x_content">
					<div class="form-group has-feedback" style="position: relative;">
					  ...
					  <input type="text" name="name" class="form-control" required value="<?php echo $findusData->name;?>">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div id="logo">
                            <?php 
                            if($findusData->logo!=""){?>
                                <img class="side_img" src="<?= base_url(); ?>/uploads/logo/<?php echo $findusData->logo;?>">
                            <?php } ?>
                        </div>
                    </div>
                </div>
